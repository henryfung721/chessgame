...
public class Chessboard1 extends Fragment implements View.OnClickListener{
    ...
    private static ImageButton [] imageButtonarray = new ImageButton[idarray.length];
    ...
    public void setfigure(){
        for(int i =0;i<idarray.length;i++){
            ...
            } else if(chessboardclass.board[x][y]==chessboardclass.Pawn){
                imageButtonarray[i].setImageResource(R.drawable.blackpawn);
            }else if(chessboardclass.board[x][y]==chessboardclass.Rook){
                imageButtonarray[i].setImageResource(R.drawable.blackpawn);
            }else if(chessboardclass.board[x][y]==chessboardclass.Knight){

            }else if(chessboardclass.board[x][y]==chessboardclass.Bishop){

            }else if(chessboardclass.board[x][y]==chessboardclass.Queen){

            }else if(chessboardclass.board[x][y]==chessboardclass.King){
