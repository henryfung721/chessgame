...
public class user_login_questionaire extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questionaire_page);

        currentsection=(TextView)findViewById(R.id.current_mode);
        Q1questoin=(TextView)findViewById(R.id.Q1_1_question);
        Q2questoin=(TextView)findViewById(R.id.Q1_2_question);
        Q3questoin=(TextView)findViewById(R.id.Q1_3_question);

        Q1description=(TextView)findViewById(R.id.Q1_1_description);
        Q2description=(TextView)findViewById(R.id.Q1_2_description);
        Q3description=(TextView)findViewById(R.id.Q1_3_description);

        Q1seekBar=(SeekBar)findViewById(R.id.Q1_1_seekBar);
        Q2seekBar=(SeekBar)findViewById(R.id.Q1_2_seekBar);
        Q3seekBar=(SeekBar)findViewById(R.id.Q1_3_seekBar);

        nextbutton=(Button)findViewById(R.id.next_button1);
        nextbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { next_button_function(); }
        });
        canecelbutton=(Button)findViewById(R.id.cancel_button1);
    ...
    private void next_button_function() {
        ...
        Intent intent = new Intent(user_login_questionaire.this,matching_mode_questionaire.class);
