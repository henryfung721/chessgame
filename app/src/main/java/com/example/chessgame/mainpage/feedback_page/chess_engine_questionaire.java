...
public class chess_engine_questionaire extends AppCompatActivity {


    TextView Q1questoin,Q1description;
    TextView Q2questoin,Q2description;
    TextView Q3questoin,Q3description;
    TextView Q4questoin,Q4description;
    SeekBar Q1seekBar,Q2seekBar,Q3seekBar,Q4seekBar;

    TextView currentsection;

    public static String section,q1description,q2description,q3description,q4description;
    public static String Q1answer,Q2answer,Q3answer,Q4answer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questionaire3_page);
        currentsection=(TextView)findViewById(R.id.current_mode);

        Q1questoin=(TextView)findViewById(R.id.Q3_1_question);
        Q2questoin=(TextView)findViewById(R.id.Q3_2_question);
        Q3questoin=(TextView)findViewById(R.id.Q3_3_question);
        Q4questoin=(TextView)findViewById(R.id.Q3_4_question);

        Q1description=(TextView)findViewById(R.id.Q3_1_description);
        Q2description=(TextView)findViewById(R.id.Q3_2_description);
        Q3description=(TextView)findViewById(R.id.Q3_3_description);
        Q4description=(TextView)findViewById(R.id.Q3_4_description);

        Q1seekBar=(SeekBar)findViewById(R.id.Q3_1_seekBar);
        Q2seekBar=(SeekBar)findViewById(R.id.Q3_2_seekBar);
        Q3seekBar=(SeekBar)findViewById(R.id.Q3_3_seekBar);
        Q4seekBar=(SeekBar)findViewById(R.id.Q3_4_seekBar);
        ...
        canecelbutton=(Button)findViewById(R.id.cancel_button3);
    ...
    private void next_button_function() {
        ...
        q4description=Q4questoin.getText().toString().substring(0, Q4questoin.getText().toString().length() - 1);

        Q1answer=Q1description.getText().toString();
        Q2answer=Q2description.getText().toString();
        Q3answer=Q3description.getText().toString();
        Q4answer=Q4description.getText().toString();
        Intent intent = new Intent(chess_engine_questionaire.this,feedback_section.class);
    ...
    private void resetpage() {
        ...
        setseekbarfunctions(Q4seekBar,Q4description);
    }
