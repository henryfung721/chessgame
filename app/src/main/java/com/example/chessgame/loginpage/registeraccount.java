...
public class registeraccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dataverification(Email,Password,name,confirmedPassword);
        ...
        registerbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(registeraccount.this, com.example.chessgame.loginpage.login.class);
    ...
    public void dataverification(String Email,String Password,String name,String Confirmedpassword){
